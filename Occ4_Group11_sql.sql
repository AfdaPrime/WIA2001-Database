...
--if user wants to keep staff's sex slao
ALTER TABLE Staff
ADD sex VARCHAR(10);
--test
DESC Staff;
...
--DELETE
--to delete 1 record in the table
--If a room won't be offered to customer anymore, 
--the according record needs to be deleted in the room table
